...
def generate_launch_description():
    ...
    servo_yaml = load_yaml("ur_moveit_servo", "config/ur_servo_config.yaml")
    servo_params = {"moveit_servo": servo_yaml}

    declared_arguments = []
    # UR10e specific arguments
    ...
    #     get_package_share_directory("ur_moveit_servo"),
    #     "config",
    #     "fake_hardware_controllers.yaml",
    # )
    ...
    container = ComposableNodeContainer(
        name="moveit_servo_ur10e_container",
        namespace="/",
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                package="ur_moveit_servo",
                plugin="ur_moveit_servo::JoyToServoPub",
                name="ur10e_controller_to_servo_node",
                #extra_arguments=[{"use_intra_process_comms": True}],
            ),
            ComposableNode(
                package="joy",
